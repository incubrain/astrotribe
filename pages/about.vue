        ...
        <div class="flex lg:flex-row flex-col items-center">
          ...
          <div class="lg:pt-16 xl:pt-0 cursor-pointer w-full lg:w-5/12 lg:mt-0 sm:mt-10 mt-8">
            <div class="w-full grid sm:grid-cols-2 grid-cols-1">
              <!-- Company Founded -->
              <div class="pb-5 border-r-2 border-slate-300">
              ...
              <div class="sm:hidden block pb-5 border-r-2 border-slate-300">
                <div class="flex justify-between">
                  <div class="w-auto">
              ...
              <!-- 200k Users -->
              <div class="sm:block hidden pb-5 border-r-2 border-slate-300">
                <div class="flex justify-between">
                  <div class="w-auto">
