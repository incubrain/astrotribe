            ...
            >
                ...
                >
                    ...
                    <button
                        ...
                        role="button"
                        class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3
                        border rounded-lg border-gray-700 flex items-center justify-center w-full mt-10
                        hover:bg-gray-100
                    ">
                        <svg
                            width="19"
