 ...
 */
      ...
      export function isPartialsaml_providers(value: unknown): value is Partial<Isaml_providers> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","sso_provider_id","entity_id","metadata_xml","metadata_url","attribute_mapping","created_at","updated_at","name_id_format","sso_providers"];
 ...
 */
export function issaml_providersArray(value: unknown): value is Isaml_providers[] {
 ...
 */
export function isPartialsaml_providersArray(value: unknown): value is Partial<Isaml_providers>[] {
