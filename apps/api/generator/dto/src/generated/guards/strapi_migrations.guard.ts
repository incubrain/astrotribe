 ...
 */
export function isstrapi_migrations(value: unknown): value is Istrapi_migrations {
 ...
 */
      ...
      export function isPartialstrapi_migrations(value: unknown): value is Partial<Istrapi_migrations> {
 ...
 */
export function isstrapi_migrationsArray(value: unknown): value is Istrapi_migrations[] {
 ...
 */
export function isPartialstrapi_migrationsArray(value: unknown): value is Partial<Istrapi_migrations>[] {
