...
export function isPartialplan_permissions(
  value: unknown,
): value is Partial<Iplan_permissions> {
 ...
 */
export function isplan_permissionsArray(
  value: unknown,
): value is Iplan_permissions[] {
 ...
 */
export function isPartialplan_permissionsArray(
  value: unknown,
): value is Partial<Iplan_permissions>[] {
