 ...
 */
      ...
      export function isPartialresponses(value: unknown): value is Partial<Iresponses> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","search_id","output","upvotes","downvotes","created_at","searches"];
 ...
 */
export function isPartialresponsesArray(value: unknown): value is Partial<Iresponses>[] {
