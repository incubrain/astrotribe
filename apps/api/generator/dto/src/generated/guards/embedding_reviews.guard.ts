 ...
 */
export function isembedding_reviews(
  value: unknown,
): value is Iembedding_reviews {
...
export function isPartialembedding_reviews(
  value: unknown,
): value is Partial<Iembedding_reviews> {
 ...
 */
export function isembedding_reviewsArray(
  value: unknown,
): value is Iembedding_reviews[] {
 ...
 */
export function isPartialembedding_reviewsArray(
  value: unknown,
): value is Partial<Iembedding_reviews>[] {
