 ...
 */
      ...
      export function isPartialmfa_amr_claims(value: unknown): value is Partial<Imfa_amr_claims> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["session_id","created_at","updated_at","authentication_method","id","sessions"];
 ...
 */
export function ismfa_amr_claimsArray(value: unknown): value is Imfa_amr_claims[] {
 ...
 */
export function isPartialmfa_amr_claimsArray(value: unknown): value is Partial<Imfa_amr_claims>[] {
