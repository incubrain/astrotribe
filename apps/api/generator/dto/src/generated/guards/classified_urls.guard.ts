 ...
 */
      ...
      export function isPartialclassified_urls(value: unknown): value is Partial<Iclassified_urls> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","url","predicted_category","actual_category","is_reviewed","added_to_training","created_at","updated_at"];
 ...
 */
export function isclassified_urlsArray(value: unknown): value is Iclassified_urls[] {
 ...
 */
export function isPartialclassified_urlsArray(value: unknown): value is Partial<Iclassified_urls>[] {
