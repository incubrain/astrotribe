 ...
 */
export function isschema_migrations(value: unknown): value is Ischema_migrations {
 ...
 */
      ...
      export function isPartialschema_migrations(value: unknown): value is Partial<Ischema_migrations> {
 ...
 */
export function isschema_migrationsArray(value: unknown): value is Ischema_migrations[] {
 ...
 */
export function isPartialschema_migrationsArray(value: unknown): value is Partial<Ischema_migrations>[] {
