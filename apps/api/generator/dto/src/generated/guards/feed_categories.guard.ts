 ...
 */
      ...
      export function isPartialfeed_categories(value: unknown): value is Partial<Ifeed_categories> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","created_at","feed_id","category_id","categories","feeds"];
 ...
 */
export function isfeed_categoriesArray(value: unknown): value is Ifeed_categories[] {
 ...
 */
export function isPartialfeed_categoriesArray(value: unknown): value is Partial<Ifeed_categories>[] {
