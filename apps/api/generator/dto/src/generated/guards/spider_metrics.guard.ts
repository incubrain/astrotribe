 ...
 */
      ...
      export function isPartialspider_metrics(value: unknown): value is Partial<Ispider_metrics> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","crawl_id","metric_id","timestamp","value","metric_definitions"];
 ...
 */
export function isspider_metricsArray(value: unknown): value is Ispider_metrics[] {
 ...
 */
export function isPartialspider_metricsArray(value: unknown): value is Partial<Ispider_metrics>[] {
