 ...
 */
      ...
      export function isPartialnews_tags(value: unknown): value is Partial<Inews_tags> {
 ...
 */
export function isPartialnews_tagsArray(value: unknown): value is Partial<Inews_tags>[] {
