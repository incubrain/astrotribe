...
export function isPartialsso_providers(
  value: unknown,
): value is Partial<Isso_providers> {
 ...
 */
export function issso_providersArray(
  value: unknown,
): value is Isso_providers[] {
 ...
 */
export function isPartialsso_providersArray(
  value: unknown,
): value is Partial<Isso_providers>[] {
