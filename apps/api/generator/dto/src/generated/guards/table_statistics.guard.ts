...
export function isPartialtable_statistics(
  value: unknown,
): value is Partial<Itable_statistics> {
 ...
 */
export function istable_statisticsArray(
  value: unknown,
): value is Itable_statistics[] {
 ...
 */
export function isPartialtable_statisticsArray(
  value: unknown,
): value is Partial<Itable_statistics>[] {
