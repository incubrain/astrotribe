 ...
 */
      ...
      export function isPartialcompany_metrics(value: unknown): value is Partial<Icompany_metrics> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","crawl_id","company_id","metric_id","timestamp","value","metric_definitions"];
 ...
 */
export function iscompany_metricsArray(value: unknown): value is Icompany_metrics[] {
 ...
 */
export function isPartialcompany_metricsArray(value: unknown): value is Partial<Icompany_metrics>[] {
