 ...
 */
      ...
      export function isPartialnewsletters(value: unknown): value is Partial<Inewsletters> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","title","frequency","start_date","end_date","generated_content","created_at","updated_at","content_status","contents"];
 ...
 */
export function isPartialnewslettersArray(value: unknown): value is Partial<Inewsletters>[] {
