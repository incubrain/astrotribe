 ...
 */
      ...
      export function isPartialjob_metrics(value: unknown): value is Partial<Ijob_metrics> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","job_name","job_id","status","started_at","completed_at","failed_at","duration_ms","items_processed","error_message","error_stack","metadata","created_at","updated_at"];
 ...
 */
export function isPartialjob_metricsArray(value: unknown): value is Partial<Ijob_metrics>[] {
