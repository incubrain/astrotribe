 ...
 */
export function iscontent_categories(
  value: unknown,
): value is Icontent_categories {
...
export function isPartialcontent_categories(
  value: unknown,
): value is Partial<Icontent_categories> {
 ...
 */
export function iscontent_categoriesArray(
  value: unknown,
): value is Icontent_categories[] {
 ...
 */
export function isPartialcontent_categoriesArray(
  value: unknown,
): value is Partial<Icontent_categories>[] {
