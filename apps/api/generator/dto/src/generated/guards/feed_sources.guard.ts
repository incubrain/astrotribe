 ...
 */
      ...
      export function isPartialfeed_sources(value: unknown): value is Partial<Ifeed_sources> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","feed_id","created_at","content_source_id","feeds","content_sources"];
 ...
 */
export function isPartialfeed_sourcesArray(value: unknown): value is Partial<Ifeed_sources>[] {
