 ...
 */
      ...
      export function isPartialmfa_factors(value: unknown): value is Partial<Imfa_factors> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","user_id","friendly_name","factor_type","status","created_at","updated_at","secret","phone","last_challenged_at","web_authn_credential","web_authn_aaguid","mfa_challenges","users"];
 ...
 */
export function isPartialmfa_factorsArray(value: unknown): value is Partial<Imfa_factors>[] {
