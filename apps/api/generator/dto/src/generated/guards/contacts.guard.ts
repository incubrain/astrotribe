 ...
 */
      ...
      export function isPartialcontacts(value: unknown): value is Partial<Icontacts> {
        ...
        const knownKeys = ["id","title","is_primary","email","contact_type","privacy_level","user_id","created_at","updated_at","phone","company_id","company_contacts","companies","user_profiles"];
 ...
 */
export function isPartialcontactsArray(value: unknown): value is Partial<Icontacts>[] {
