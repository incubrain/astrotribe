 ...
 */
export function isblacklisted_domains(
  value: unknown,
): value is Iblacklisted_domains {
...
export function isPartialblacklisted_domains(
  value: unknown,
): value is Partial<Iblacklisted_domains> {
 ...
 */
export function isblacklisted_domainsArray(
  value: unknown,
): value is Iblacklisted_domains[] {
 ...
 */
export function isPartialblacklisted_domainsArray(
  value: unknown,
): value is Partial<Iblacklisted_domains>[] {
