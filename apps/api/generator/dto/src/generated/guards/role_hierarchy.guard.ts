...
export function isPartialrole_hierarchy(
  value: unknown,
): value is Partial<Irole_hierarchy> {
 ...
 */
export function isrole_hierarchyArray(
  value: unknown,
): value is Irole_hierarchy[] {
 ...
 */
export function isPartialrole_hierarchyArray(
  value: unknown,
): value is Partial<Irole_hierarchy>[] {
