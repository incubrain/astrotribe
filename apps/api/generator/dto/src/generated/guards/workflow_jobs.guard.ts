...
export function isPartialworkflow_jobs(
  value: unknown,
): value is Partial<Iworkflow_jobs> {
 ...
 */
export function isworkflow_jobsArray(
  value: unknown,
): value is Iworkflow_jobs[] {
 ...
 */
export function isPartialworkflow_jobsArray(
  value: unknown,
): value is Partial<Iworkflow_jobs>[] {
