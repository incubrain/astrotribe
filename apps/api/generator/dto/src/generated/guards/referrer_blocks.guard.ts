 ...
 */
      ...
      export function isPartialreferrer_blocks(value: unknown): value is Partial<Ireferrer_blocks> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","referrer_code","blocked_at","blocked_by","reason","is_permanent","created_at","updated_at"];
 ...
 */
export function isreferrer_blocksArray(value: unknown): value is Ireferrer_blocks[] {
 ...
 */
export function isPartialreferrer_blocksArray(value: unknown): value is Partial<Ireferrer_blocks>[] {
