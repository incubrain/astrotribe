 ...
 */
      ...
      export function isPartialerror_logs(value: unknown): value is Partial<Ierror_logs> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","service_name","error_type","severity","message","stack_trace","metadata","context","user_id","request_id","correlation_id","environment","created_at","error_hash","error_pattern","is_new_pattern","github_repo","related_errors","frequency_data","domain"];
 ...
 */
export function isPartialerror_logsArray(value: unknown): value is Partial<Ierror_logs>[] {
