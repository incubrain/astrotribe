 ...
 */
      ...
      export function isPartialbookmark_folders(value: unknown): value is Partial<Ibookmark_folders> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","user_id","name","color","parent_id","is_default","is_favorite","position","created_at","updated_at","bookmark_folders","other_bookmark_folders","users","bookmarks"];
 ...
 */
export function isbookmark_foldersArray(value: unknown): value is Ibookmark_folders[] {
 ...
 */
export function isPartialbookmark_foldersArray(value: unknown): value is Partial<Ibookmark_folders>[] {
