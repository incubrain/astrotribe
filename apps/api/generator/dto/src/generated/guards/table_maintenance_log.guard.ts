 ...
 */
export function istable_maintenance_log(
  value: unknown,
): value is Itable_maintenance_log {
...
export function isPartialtable_maintenance_log(
  value: unknown,
): value is Partial<Itable_maintenance_log> {
 ...
 */
export function istable_maintenance_logArray(
  value: unknown,
): value is Itable_maintenance_log[] {
 ...
 */
export function isPartialtable_maintenance_logArray(
  value: unknown,
): value is Partial<Itable_maintenance_log>[] {
