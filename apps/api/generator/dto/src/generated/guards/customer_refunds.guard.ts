 ...
 */
      ...
      export function isPartialcustomer_refunds(value: unknown): value is Partial<Icustomer_refunds> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","payment_id","external_refund_id","amount","status","speed_processed","speed_requested","notes","created_at","currency","receipt","acquirer_data","batch_id","customer_payments"];
 ...
 */
export function iscustomer_refundsArray(value: unknown): value is Icustomer_refunds[] {
 ...
 */
export function isPartialcustomer_refundsArray(value: unknown): value is Partial<Icustomer_refunds>[] {
