 ...
 */
export function isrole_permissions_materialized(
  value: unknown,
): value is Irole_permissions_materialized {
...
export function isPartialrole_permissions_materialized(
  value: unknown,
): value is Partial<Irole_permissions_materialized> {
 ...
 */
export function isrole_permissions_materializedArray(
  value: unknown,
): value is Irole_permissions_materialized[] {
 ...
 */
export function isPartialrole_permissions_materializedArray(
  value: unknown,
): value is Partial<Irole_permissions_materialized>[] {
  return (
    Array.isArray(value) && value.every(isPartialrole_permissions_materialized)
  );
}
