 ...
 */
      ...
      export function isPartialsessions(value: unknown): value is Partial<Isessions> {
        ...
        const knownKeys = ["id","user_id","created_at","updated_at","factor_id","aal","not_after","refreshed_at","user_agent","ip","tag","mfa_amr_claims","refresh_tokens","users"];
 ...
 */
export function isPartialsessionsArray(value: unknown): value is Partial<Isessions>[] {
