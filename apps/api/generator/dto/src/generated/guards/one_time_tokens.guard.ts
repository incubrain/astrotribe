 ...
 */
      ...
      export function isPartialone_time_tokens(value: unknown): value is Partial<Ione_time_tokens> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","user_id","token_type","token_hash","relates_to","created_at","updated_at","users"];
 ...
 */
export function isone_time_tokensArray(value: unknown): value is Ione_time_tokens[] {
 ...
 */
export function isPartialone_time_tokensArray(value: unknown): value is Partial<Ione_time_tokens>[] {
