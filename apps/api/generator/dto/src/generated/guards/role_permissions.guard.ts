 ...
 */
      ...
      export function isPartialrole_permissions(value: unknown): value is Partial<Irole_permissions> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","role","table_name","conditions","permissions","cached_permissions","inherit_from","last_updated"];
 ...
 */
export function isrole_permissionsArray(value: unknown): value is Irole_permissions[] {
 ...
 */
export function isPartialrole_permissionsArray(value: unknown): value is Partial<Irole_permissions>[] {
