 ...
 */
export function ismetric_definitions(
  value: unknown,
): value is Imetric_definitions {
...
export function isPartialmetric_definitions(
  value: unknown,
): value is Partial<Imetric_definitions> {
 ...
 */
export function ismetric_definitionsArray(
  value: unknown,
): value is Imetric_definitions[] {
 ...
 */
export function isPartialmetric_definitionsArray(
  value: unknown,
): value is Partial<Imetric_definitions>[] {
