 ...
 */
      ...
      export function isPartialinstances(value: unknown): value is Partial<Iinstances> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","uuid","raw_base_config","created_at","updated_at"];
 ...
 */
export function isPartialinstancesArray(value: unknown): value is Partial<Iinstances>[] {
