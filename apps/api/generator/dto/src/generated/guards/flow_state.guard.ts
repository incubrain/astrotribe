 ...
 */
      ...
      export function isPartialflow_state(value: unknown): value is Partial<Iflow_state> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","user_id","auth_code","code_challenge_method","code_challenge","provider_type","provider_access_token","provider_refresh_token","created_at","updated_at","authentication_method","auth_code_issued_at","saml_relay_states"];
 ...
 */
export function isPartialflow_stateArray(value: unknown): value is Partial<Iflow_state>[] {
