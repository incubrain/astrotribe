 ...
 */
      ...
      export function isPartialscoring_weights(value: unknown): value is Partial<Iscoring_weights> {
 ...
 */
export function isscoring_weightsArray(value: unknown): value is Iscoring_weights[] {
 ...
 */
export function isPartialscoring_weightsArray(value: unknown): value is Partial<Iscoring_weights>[] {
