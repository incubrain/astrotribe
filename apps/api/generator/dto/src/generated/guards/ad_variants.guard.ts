 ...
 */
      ...
      export function isPartialad_variants(value: unknown): value is Partial<Iad_variants> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","ad_id","content","is_control","active","created_at","updated_at","performance_metrics","ad_daily_metrics","ads"];
 ...
 */
export function isPartialad_variantsArray(value: unknown): value is Partial<Iad_variants>[] {
