 ...
 */
      ...
      export function isPartialnews(value: unknown): value is Partial<Inews> {
        ...
        const knownKeys = ["created_at","updated_at","title","body","category_id","author","description","featured_image","has_summary","published_at","url","hash","id","company_id","failed_count","scrape_frequency","scraped_at","content_status","keywords","content_source_id","content_sources","categories","companies","contents","news_summaries"];
