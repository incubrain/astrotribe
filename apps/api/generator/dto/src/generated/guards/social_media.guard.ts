 ...
 */
      ...
      export function isPartialsocial_media(value: unknown): value is Partial<Isocial_media> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","facebook_url","twitter_url","linkedin_url","instagram_url","youtube_url","created_at","updated_at","companies"];
 ...
 */
export function isPartialsocial_mediaArray(value: unknown): value is Partial<Isocial_media>[] {
