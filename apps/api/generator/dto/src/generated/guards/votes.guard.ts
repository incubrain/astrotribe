 ...
 */
      ...
      export function isPartialvotes(value: unknown): value is Partial<Ivotes> {
        ...
        const knownKeys = ["id","content_type","content_id","user_id","vote_type","created_at","users"];
 ...
 */
export function isPartialvotesArray(value: unknown): value is Partial<Ivotes>[] {
