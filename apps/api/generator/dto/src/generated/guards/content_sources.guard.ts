 ...
 */
      ...
      export function isPartialcontent_sources(value: unknown): value is Partial<Icontent_sources> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["id","url","content_type","scrape_frequency","created_at","updated_at","refreshed_at","has_failed","failed_count","priority","hash","scraped_at","expected_count","company_id","rss_urls","companies","feed_sources","news"];
 ...
 */
export function iscontent_sourcesArray(value: unknown): value is Icontent_sources[] {
 ...
 */
export function isPartialcontent_sourcesArray(value: unknown): value is Partial<Icontent_sources>[] {
