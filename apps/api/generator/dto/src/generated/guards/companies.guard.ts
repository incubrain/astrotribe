 ...
 */
      ...
      export function isPartialcompanies(value: unknown): value is Partial<Icompanies> {
        if (typeof value !== 'object' || value === null) return false;

        const knownKeys = ["name","description","logo_url","url","social_media_id","scrape_frequency","category_id","created_at","updated_at","founding_year","is_government","category","failed_count","is_english","scrape_rating","id","scraped_at","content_status","keywords","addresses","ads","blacklisted_urls","social_media","categories","company_contacts","company_extras","company_urls","contacts","content_sources","news"];
 ...
 */
export function isPartialcompaniesArray(value: unknown): value is Partial<Icompanies>[] {
