...
/**
  ...
  export interface mfa_factorsWithmfa_challenges extends mfa_factors {
    mfa_challenges: Imfa_challenges;
  }

export interface mfa_factorsWithusers extends mfa_factors {
    users: Iusers;
  }
  
  /**
   * Helper types for working with mfa_factors
   */
  export type Partialmfa_factors = Partial<mfa_factors>
  export type Requiredmfa_factors = Required<mfa_factors>
  export type Pickmfa_factors<K extends keyof mfa_factors> = Pick<mfa_factors, K>