...
/**
     ...
     * @validation @IsNotEmpty, @IsString{{/if}}
     */
    factor_id{{#unless required}}?{{/unless}}: unknown;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
     ...
     */
    verified_at{{#unless required}}?{{/unless}}: unknown;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
     ...
     */
    otp_code{{#unless required}}?{{/unless}}: unknown;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
     ...
     * @validation {{/if}}
     */
    web_authn_session_data{{#unless required}}?{{/unless}}: unknown;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
