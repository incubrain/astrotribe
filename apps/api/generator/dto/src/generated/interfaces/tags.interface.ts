...
/**
     ...
     * @validation @IsNotEmpty{{/if}}
     */
    news_tags{{#unless required}}?{{/unless}}: unknown;
  }
  
  export interface tagsWithcontent_tags extends tags {
    content_tags: Icontent_tags;
  }

export interface tagsWithnews_tags extends tags {
    news_tags: Inews_tags;
  }
  
  /**
   * Helper types for working with tags
   */
  export type Partialtags = Partial<tags>
  export type Requiredtags = Required<tags>
  export type Picktags<K extends keyof tags> = Pick<tags, K>