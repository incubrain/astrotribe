...
/**
     ...
     */
    cancel_at_period_end{{#unless required}}?{{/unless}}: boolean;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
     ...
     * @validation @IsBoolean{{/if}}
     */
    customer_notify{{#unless required}}?{{/unless}}: boolean;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
     ...
     * @validation @IsBoolean{{/if}}
     */
    has_scheduled_changes{{#unless required}}?{{/unless}}: boolean;
/**
     * 
     *{{#if example}}
     * @example {{/if}}
...
export interface customer_subscriptionsWithpayment_providers extends customer_subscriptions {
    payment_providers: Ipayment_providers;
  }

export interface customer_subscriptionsWithcustomer_subscription_plans extends customer_subscriptions {
    customer_subscription_plans: Icustomer_subscription_plans;
  }

export interface customer_subscriptionsWithuser_profiles extends customer_subscriptions {
    user_profiles: Iuser_profiles;
  }
  
  /**
   * Helper types for working with customer_subscriptions
   */
  export type Partialcustomer_subscriptions = Partial<customer_subscriptions>
  export type Requiredcustomer_subscriptions = Required<customer_subscriptions>
  export type Pickcustomer_subscriptions<K extends keyof customer_subscriptions> = Pick<customer_subscriptions, K>