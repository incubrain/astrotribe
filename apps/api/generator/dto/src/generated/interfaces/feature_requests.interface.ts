...
This model contains row level security and requires additional setup for migrations. Visit https://pris.ly/d/row-level-security for more info.
   ...
   * @version {{/if}}
   */
  export interface feature_requests {
  /**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
  ...
  export interface feature_requestsWithfeature_votes extends feature_requests {
    feature_votes: Ifeature_votes;
  }
  
  /**
   * Helper types for working with feature_requests
   */
  export type Partialfeature_requests = Partial<feature_requests>
  export type Requiredfeature_requests = Required<feature_requests>
  export type Pickfeature_requests<K extends keyof feature_requests> = Pick<feature_requests, K>