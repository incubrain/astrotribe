// This file is auto-generated. Do not modify manually.
   ...
   * @version {{/if}}
   */
  export interface company_metrics {
  /**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
  ...
  /**
   * Helper types for working with company_metrics
   */
  export type Partialcompany_metrics = Partial<company_metrics>
  export type Requiredcompany_metrics = Required<company_metrics>
  export type Pickcompany_metrics<K extends keyof company_metrics> = Pick<company_metrics, K>