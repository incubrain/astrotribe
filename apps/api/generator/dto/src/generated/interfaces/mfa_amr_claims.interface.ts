...
/**
  ...
  /**
   * Helper types for working with mfa_amr_claims
   */
  export type Partialmfa_amr_claims = Partial<mfa_amr_claims>
  export type Requiredmfa_amr_claims = Required<mfa_amr_claims>
  export type Pickmfa_amr_claims<K extends keyof mfa_amr_claims> = Pick<mfa_amr_claims, K>