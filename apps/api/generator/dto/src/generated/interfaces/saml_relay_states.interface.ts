...
/**
  ...
  export interface saml_relay_statesWithflow_state extends saml_relay_states {
    flow_state: Iflow_state;
  }

export interface saml_relay_statesWithsso_providers extends saml_relay_states {
    sso_providers: Isso_providers;
  }
  
  /**
   * Helper types for working with saml_relay_states
   */
  export type Partialsaml_relay_states = Partial<saml_relay_states>
  export type Requiredsaml_relay_states = Required<saml_relay_states>
  export type Picksaml_relay_states<K extends keyof saml_relay_states> = Pick<saml_relay_states, K>