// This file is auto-generated. Do not modify manually.
   ...
   * @version {{/if}}
   */
  export interface research_embeddings {
  /**
     * 
     *{{#if example}}
     * @example {{/if}}
...
/**
  ...
  export interface research_embeddingsWithembedding_reviews extends research_embeddings {
    embedding_reviews: Iembedding_reviews;
  }

export interface research_embeddingsWithresearch extends research_embeddings {
    research: Iresearch;
  }
  
  /**
   * Helper types for working with research_embeddings
   */
  export type Partialresearch_embeddings = Partial<research_embeddings>
  export type Requiredresearch_embeddings = Required<research_embeddings>
  export type Pickresearch_embeddings<K extends keyof research_embeddings> = Pick<research_embeddings, K>