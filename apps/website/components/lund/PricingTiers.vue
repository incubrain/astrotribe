...
const trackCtaClick = (plan: string) => {
  trackUserAcquisition(UserAcquisitionMetric.Conversion, {
    plan,
      ...
      >
        ...
        <div class="flex items-center justify-center space-x-4 mb-2">
          ...
          >
            ...
            <span
              class="ml-2 text-xs bg-primary-900/30 text-primary-500 border border-primary-800/40 rounded-full px-2 py-0.5"
            >
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        >
          ...
          <div class="absolute -top-3 inset-x-0 flex justify-center z-20">
            <span
              class="bg-gradient-to-r from-blue-600 to-primary-600 text-white text-xs font-semibold px-4 py-1 rounded-full shadow-lg"
            >
              Most Popular
            </span>
          </div>
          ...
          <div
            class="h-full bg-slate-900/60 backdrop-blur-sm border border-primary-700/50 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-primary-800/20 hover:-translate-y-1 shadow-lg shadow-primary-900/10"
          >
            <div class="p-8">
              <h3 class="text-2xl font-bold text-white mb-2">Basic</h3>
              <p class="text-gray-400 text-sm mb-6"
                >For serious researchers and astronomy enthusiasts</p
              >
              ...
              <div class="space-y-4 mb-8">
                <div class="flex items-start">
                  <Icon
                    name="mdi:check-circle"
                    class="flex-shrink-0 mt-0.5 mr-3 text-primary-500"
                    size="20"
                  />
                ...
                <div class="flex items-start">
                  <Icon
                    ...
                    size="20"
                  />
                  <span class="text-gray-300">Custom contexts</span>
                </div>
              </div>

              <!-- CTA Button -->
              <PrimeButton
                class="w-full bg-primary-600 hover:bg-primary-500 border-none shadow"
        ...
        >
          ...
          <div class="absolute -top-3 right-4 z-10">
            <span
              class="bg-blue-600/90 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md"
            >
              Coming Soon
            </span>
          </div>
          ...
          <div
            class="h-full bg-slate-900/60 backdrop-blur-sm border border-blue-800/30 rounded-xl overflow-hidden transition-all duration-300 opacity-80 hover:shadow-lg"
          >
            <div class="p-6">
              <h3 class="text-2xl font-bold text-white mb-2">Expert</h3>
              <p class="text-gray-400 text-sm mb-6"
                >For professional researchers and organizations</p
              >
              ...
              <!-- CTA Button -->
              <PrimeButton
                class="w-full bg-blue-600/80 hover:bg-blue-600/90 border-none"
                disabled
              >
                Join Waitlist
              </PrimeButton>
