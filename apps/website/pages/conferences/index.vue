...
const conferences = [
  {
    ...
    slug: '/conferences/dark-sky-conference-2023',
  },
]
</script>
...
<template>
  <div>
    <CommonHero
      ...
      :title="{
        main: 'AstronEra Conferences',
        subtitle: 'Come Look At Our Conferences',
      }"
      position="center"
      invert
    />
    <div
      class="pt-20 wrapper relative grid w-full grid-cols-1 items-start md:gap-4 md:px-4 lg:grid-cols-[0.5fr_1fr] lg:gap-8 lg:px-8"
    >
      <BlogAdFloat />
      <div
        v-show="conferences.length"
