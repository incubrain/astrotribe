...
<template>
  <div class="min-h-screen wrapper text-white py-32">
    <!-- Planet Navigation Tabs -->
    <div class="py-4 border-b border-primary-800">
    ...
    <div class="wrapper py-8">
      ...
      <div class="mb-16">
        ...
        <div class="aspect-video w-full mx-auto rounded-lg overflow-hidden shadow-lg">
          <iframe
