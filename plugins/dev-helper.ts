...
export default defineNuxtPlugin((nuxtApp) => {
  ...
  const DevHelper = {
    ...
    initNetworkErrorClassifier() {
      ...
      nuxtApp.hook('app:error', (error) => {
        ...
        console.error(`🌐 Network Error (${category}):`, {
      ...
      console.log('🌐 Network Error Classifier initialized')
    },
    ...
    initInfiniteLoopDetector() {
      ...
      console.log('🔄 Infinite Loop Detector initialized')
    },
    ...
    initUnhandledPromiseRejectionTracker() {
      ...
      console.log('💥 Unhandled Promise Rejection Tracker initialized')
    },
  ...
  if (import.meta.dev && config.public.devHelper.enabled) {
    console.log('🛠️ DevHelper: Initializing...')
    try {
