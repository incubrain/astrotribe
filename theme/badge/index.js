  ...
  root: ({ props }) => ({
    class: [
      ...
      'text-primary-contrast',
      {
        ...
        'bg-surface-400': props.severity === 'secondary',
        'bg-green-400': props.severity === 'success',
        'bg-blue-400': props.severity === 'info',
        'bg-orange-400': props.severity === 'warn',
        'bg-purple-400': props.severity === 'help',
        'bg-red-400': props.severity === 'danger',
        'text-surface-900 bg-surface-0':
