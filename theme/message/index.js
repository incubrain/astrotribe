  ...
  root: ({ props }) => ({
    class: [
      ...
      // Colors
      {
        ...
        '0/20': props.severity == 'secondary',
        'bg-orange-500/20': props.severity == 'warn',
        'bg-red-500/20': props.severity == 'error',
        'bg-surface-0': props.severity == 'contrast',
      },
      {
        'outline-blue-400': props.severity == 'info',
        'outline-green-400': props.severity == 'success',
        'outline-surface-400': props.severity == 'secondary',
        'outline-orange-400': props.severity == 'warn',
        'outline-red-400': props.severity == 'error',
        'outline-surface-0': props.severity == 'contrast',
      },
      {
        'text-blue-300': props.severity == 'info',
        'text-green-300': props.severity == 'success',
        'text-surface-300': props.severity == 'secondary',
        'text-orange-300': props.severity == 'warn',
        'text-red-300': props.severity == 'error',
        'text-surface-950': props.severity == 'contrast',
      },
    ],
  }),
  content: {
