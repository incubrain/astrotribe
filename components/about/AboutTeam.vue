<template>
    ...
    <div class="flex justify-center items-center flex-col py-12 px-4 md:px-6 ">
        <div class="flex justify-center items-center flex-col space-y-4">
            <h1 class="text-3xl xl:text-4xl font-extrabold leading-8 xl:leading-9 text-gray-800 dark:text-white">Our Team</h1>
            <p class="w-11/12 text-base leading-normal text-center text-gray-600 dark:text-gray-200">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
        </div>
        <div class="mt-6 md:mt-10 xl:mt-14 grid grid-cols-1 md:grid-cols-2  lg:grid-cols-5 gap-y-12 md:gap-y-14 md:gap-x-24 xl:gap-y-0 lg:gap-x-14">
            <div class="flex flex-col items-center justify-center space-y-4">
                ...
                <div class="flex flex-col justify-center items-center space-y-2">
                    <p class="text-base font-semibold leading-none text-center text-gray-800 dark:text-white">Gustavo Workman</p>
                    <p class="text-sm leading-none text-center text-gray-600 dark:text-gray-200">Head, Product Design</p>
                </div>
            </div>
            <div class="flex flex-col items-center justify-center space-y-4">
                <div class="w-24">
