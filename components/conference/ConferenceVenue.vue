<template>
  <div class="grid items-start grid-cols-1 gap-6 xl:gap-12 lg:grid-cols-2 relative">
    ...
    >
      <div class="w-full leading-6 text-left row-start-2 h-full">
        <h4 class="pb-4 text-md font-semibold leading-7"> Why Manu Allaya? </h4>
...
const venue = {
  ...
  images: [
    ...
    {
      src: 'conference/manu-allaya-daytime-courtyard-view.jpg',
