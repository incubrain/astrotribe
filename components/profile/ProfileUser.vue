<template>
    <ProfileBlockCoverImg />    
        ...
        >
            ...
            >
                <ProfileBlockText :body="user.introduction" title="Introduction" class=" lg:col-span-2" />
...
import ProfileBlockCoverImg from './block/ProfileBlockCoverImg.vue'
