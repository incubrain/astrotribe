    ...
    <div class="container px-6 mx-auto">
      <div class="relative w-full">
        <div class="absolute w-full -mt-20 h-auto md:h-20 bg-gray-800">
          <div class="md:hidden mt-8 -mb-1 w-full relative">
            ...
            <select
              ...
              class="focus:outline-none form-select block w-full p-3 border-t border-l border-r border-gray-300 rounded-b text-gray-600 appearance-none bg-transparent relative z-10"
            >
              <option
                selected="true"
          ...
          <ul class="hidden md:flex flex-row h-full">
            <li class="border-l mt-6 rounded-t text-sm text-gray-800 px-10 py-4"> Quarterly </li>
        ...
        <div class="container mx-auto mb-10 h-64 shadow rounded-b">
