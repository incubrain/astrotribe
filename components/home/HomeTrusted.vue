<template>
  <div
    class="flex flex-col gap-8 bg-zinc-200 dark:bg-zinc-300 rounded-[0_0_.5rem_.5rem] px-4 md:px-8 pb-8 pt-4 md:pt-8 md:pb-12"
  >
    <h4 class="block gap-4 text-lg font-bold text-center uppercase text-zinc-800">
      Supported by
    </h4>
