<template>
    ...
    >
        ...
        />
        <div
            class="text-black row-start-3 row-span-2 w-full col-span-1 col-start-1 relative transition-all duration-500 ease-in-out"
        >
            <div class="p-8 absolute bottom-0 bg-white w-full">
                <NuxtLink :to="`/news/article/${post.id}`">
                    <button
                        class="h-[40px] px-8 bg-[#440439] rounded-md absolute top-[-20px] left-0 right-0 w-[80%] shadow-lg mx-auto text-white font-bold before:content-['Category'] group-hover:before:content-['Read_more']"
                    ></button>
                </NuxtLink>
